...
#     python design_baselines/smcdiffopt/__init__.py --seed $SEED --num-timesteps 100 --beta-scaling 10 --task "Superconductor-RandomForest-v0" --noise-sample-size 1
    ...
    python design_baselines/smcdiffopt/__init__.py --seed $SEED --num-timesteps 100 --beta-scaling 10 --task "Superconductor-RandomForest-v0" --noise-sample-size 10 --noise-schedule "flow"
    python design_baselines/smcdiffopt/__init__.py --seed $SEED --num-timesteps 100 --beta-scaling 10 --task "Superconductor-RandomForest-v0" --noise-sample-size 10 --noise-schedule "diffusion"
done
